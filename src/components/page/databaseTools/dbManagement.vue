...
<!--                           <el-button
         ...
         <el-col :span="18" style="height:100%"   v-loading="viewDialog.isLoading">
   ...
   methods: {
      ...
      goEdit(row) {
         ...
         this.getHttp("/api/databaseTools/dataSource/editView?dataSourceId=" + row.id+"&tableName="+ row.label).then((result) => {
            ...
            this.data.projectEntity = { id: row.id, name: row.name, number: row.number,entityName:this.data.entityName };
